...
class _RenderProgressBar extends RenderBox {
  _RenderProgressBar({
    ...
    this._thumbRadius = 10.0,
    required this._thumbColor,
    required this._thumbGlowColor,
    this._thumbGlowRadius = 30.0,
    this._thumbCanPaintOutsideBar = true,
    required this._timeLabelType,
    this._onRightTimeLabelTap,
    this._timeLabelTextStyle,
    this._timeLabelPadding = 0.0,
    this._textScaler = TextScaler.noScaling,
    this._hoverPosition,
    required this._tooltipBgColor,
    required this._tooltipTextStyle,
