...
import 'package:nordplayer/widgets/settings/section_expansible.dart' show InitialState;

class SectionPageTitle extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<SectionPageTitle> createState() => _SectionExpansibleState();
}

class _SectionExpansibleState extends ConsumerState<SectionPageTitle> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.body == null) {
      return Padding(padding: const EdgeInsets.symmetric(horizontal: 12.0, vertical: 8.0), child: mainSection);
    }
