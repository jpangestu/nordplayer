...
class ResizableTableLayout extends StatefulWidget {
  ...
  ///
  /// The [widths] parameter provides the exact calculated pixel width for each
  /// column in the current frame. You must wrap your cell content in `SizedBox(width: widths[i])`
  /// to ensure proper alignment with the headers.
  final Widget Function(BuildContext context, int index, List<double> widths)
  rowBuilder;
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        _controller.init(widget.columns, constraints.maxWidth);
        ...
        child: Listener(
          ...
          child: MouseRegion(
            ...
            child: CustomMultiChildLayout(
              delegate: _TableHeaderLayoutDelegate(widths: _controller.widths),
              children: [
